...
file_list = sorted(glob.glob("/home/waseem/vivi_paper/Data/WProf/LEVEL0/*P06_ZEN_LV0.nc"))
...
axs.set_ylim(-4,4)
axs.set_xlim(np.datetime64('2021-12-18T00:50'), np.datetime64('2021-12-18T06:00')) 
axs.grid()
