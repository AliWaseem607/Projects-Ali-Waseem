...
# REFL_DEMOTT = load_radar_data(
#       Path("./ali_radar_data/REFL_CHPN_redo.npy"), 
#       Path("./ali_radar_data/REFL_times_CHPN_redo.npy"),
#       np.datetime64('2021-12-17T22:00'),
#       np.datetime64('2021-12-19T12:00')
# )
...
# simuDEMOTT = out_dir + '/wrfout_Helmos_d03_CHOPIN_VL.nc'
...
namefigure = figures_directory + '/Figure1.png'
...
im0=axs[0].pcolormesh(mdates.date2num(wprof_time),Rgates,carmel_Ze_corr.T,vmin=-35,vmax=20,cmap=cmap)
...
namefigure2 = figures_directory + '/FigureS1.png'
