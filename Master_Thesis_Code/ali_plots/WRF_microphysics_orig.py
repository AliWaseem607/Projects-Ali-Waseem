...
namefigure = figures_directory + '/Figure2.png'
...
cs = axs[1].contour(wrf_time, ZZmiddle2/1000, tDEMOTT.T, levels=np.arange(-50, 0, 5), colors='dimgray',linewidths=1)
...
cs = axs[2].contour(wrf_time, ZZmiddle3/1000, tALLSIP.T, levels=np.arange(-50, 0, 5), colors='dimgray',linewidths=1)
...
namefigure2 = figures_directory + '/Figure3.png'
...
lwc =axs[0].contourf(wrf_time, ZZmiddle/1000, to_np(lwcCONTROL.T), levels=np.linspace(0, 1, 9), cmap = cmap2)
...
lwc = axs[1].contourf(wrf_time, ZZmiddle2/1000, to_np(lwcDEMOTT.T), levels=np.linspace(0, 1, 9), cmap = cmap2)
...
lwc = axs[2].contourf(wrf_time, ZZmiddle3/1000, to_np(lwcALLSIP.T), levels=np.linspace(0, 1, 9), cmap = cmap2)
