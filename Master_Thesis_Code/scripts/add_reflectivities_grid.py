...
def main(
    ...
    if not quiet:
        print()
        print(f"Starting script on {ncfile_path}")
    ...
    if "Zhh_BASTA" in ncfile.variables.keys():
        ...
        Zhh_BASTA = ncfile.createVariable("Zhh_BASTA", "f4", ("Time", "bottom_top", "south_north", "west_east"), fill_value=-999.0)
        Zhh_BASTA.units = "dBZ"
        ...
        for file in BASTA_results_path.iterdir():
            ...
            Zhh = radar_ncfile.variables["Zhh"][:]
    ...
    if "Zhh_MIRA" in ncfile.variables.keys():
        ...
        Zhh_MIRA = ncfile.createVariable("Zhh_MIRA", "f4", ("Time", "bottom_top","south_north", "west_east"), fill_value=-999.0)
        Zhh_MIRA.units = "dBZ"
