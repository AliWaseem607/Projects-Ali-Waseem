...
ncks -d south_north,1,4  -d south_north_stag,1,5 -d west_east,4,5 -d west_east_stag,4,6 "$L_SUBGRID_file_name" "$SUBGRID_file_name"
...
echo "Extracting HAC" 
ncks -d south_north,0,0 -d south_north_stag,0,1 -d west_east,1,1 -d west_east_stag,1,2  "$SUBGRID_file_name" "$HAC_out_file_name"
...
ncks -d south_north,3,3 -d south_north_stag,3,4 -d west_east,1,1 -d west_east_stag,1,2  "$SUBGRID_file_name" "$SPRK_out_file_name"
...
ncks -d south_north,3,3 -d south_north_stag,3,4 -d west_east,0,0 -d west_east_stag,0,1  "$SUBGRID_file_name" "$NPRK_out_file_name"
...
/home/waseem/scripts/run_crsim_multi_runner.sh "$wrfoutput_dir/$radar_ncfile_name" "$MIRA_results_path" "/home/waseem/template_files/crsim/PARAMETERS_MIRA" 10
...
/home/waseem/scripts/run_crsim_multi_runner.sh "$wrfoutput_dir/$radar_ncfile_name" "$BASTA_results_path" "/home/waseem/template_files/crsim/PARAMETERS_BASTA" 10
